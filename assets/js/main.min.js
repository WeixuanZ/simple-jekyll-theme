...
function f(a,b=!0,d=!0,c=!1){const e=document.documentElement,g=n();"dark"!==l()&&!c||"light"!==a?"light"!==l()&&!c||"dark"!==a||(b&&p(g),e.classList.add("theme-dark"),navbar.style.background="#121212",m("dark"),b&&setTimeout(()=>{p(g,!1)},1E3)):(b&&p(g),e.classList.remove("theme-dark"),navbar.style.background="#fff",m("light"),b&&setTimeout(()=>{p(g,!1)},1E3));d&&localStorage.setItem("preference-theme",a)}
function p(a,b=1){a.map(d=>{b?d.forEach(c=>c.classList.add("theme-transit")):d.forEach(c=>c.classList.remove("theme-transit"))})}function n(){return"body #navbar #main-header code #blog-list-mini .card #toc".split(" ").map(a=>document.querySelectorAll(a))}
function h(){const a=document.querySelector("#dark-toggle-label");window.addEventListener("scroll",function(){this.scrollY>=nav_init?(a.classList.add("transparent"),"dark"===l()&&(navbar.style.background="#22222280")):(a.classList.remove("transparent"),"dark"===l()&&(navbar.style.background="#121212"))})}function q(a,b){a.classList.add("transparent");setTimeout(()=>{b&&(a.innerHTML=b);a.classList.remove("transparent")},150)}
(function(){const a=document.querySelector("#main-footer"),b=a.querySelector("#copyleft"),d=b.innerHTML;let c=!1;location.href.includes("about")?b.innerHTML='<a href="/license">License and Privacy Notice</a>':location.href.includes("license")||(a.addEventListener("mouseover",function(){c||(q(b,'<a href="/license">License and Privacy Notice</a>'),c=!0)}),a.addEventListener("mouseleave",function(){q(b,d);c=!1}))})();const r=document.querySelectorAll("div.highlighter-rouge");
r.forEach(function(a,b){b=`codeblock${b+1}`;a.querySelector("code").setAttribute("id",b);let d=document.createElement("button");d.innerHTML='<i class="fas fa-clone"></i>';d.className="code-copy-btn";d.setAttribute("data-clipboard-target",`#${b}`);d.setAttribute("aria-label",`Copy ${b}`);a.querySelector("code").after(d)});0<r.length&&new ClipboardJS(".code-copy-btn");
