...
function t(a){a={type:"set-theme",theme:a};const b=document.querySelector("#utterances iframe");b&&b.contentWindow.postMessage(a,"https://weixuanz.github.io")}function n(a){addEventListener("message",()=>{t(a)},{once:!0})}
